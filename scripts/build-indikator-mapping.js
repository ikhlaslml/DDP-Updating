...
const ENUMS = {
  ...
  status_dalam_keluarga: ["Kepala Keluarga", "Suami", "Istri", "Anak", "Menantu", "Cucu", "Orang Tua", "Kakek/Nenek", "Mertua", "Famili Lain", "Lainnya"],
  agama: ["Islam", "Kristen", "Katolik", "Hindu", "Buddha", "Khonghucu", "Lainnya"],
  partisipasi_sekolah: ["Tidak/Belum Pernah Sekolah", "Masih Bersekolah", "Tidak Bersekolah Lagi"],
