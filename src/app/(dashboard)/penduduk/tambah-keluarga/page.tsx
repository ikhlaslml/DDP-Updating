  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 max-w-3xl text-sm text-slate-500">Catat keluarga baru pada bangunan yang sudah ada. Pada tahap ini cukup isi Identitas Keluarga; data lain dapat dilengkapi kemudian.</p>
      </div>
