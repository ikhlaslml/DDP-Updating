...
export default async function LayananSuratPage({ searchParams }: { searchParams: Promise<{ peristiwaId?: string }> }) {
  const { peristiwaId } = await searchParams;
  return (
    <div className="space-y-6">
      ...
      <LayananSuratView eventId={peristiwaId} />
    </div>
  );
}
