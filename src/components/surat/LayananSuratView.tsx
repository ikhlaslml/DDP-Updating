      ...
      {tab === "terbitkan" ? (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          {previewOpen && selected && template ? <section className="lg:col-span-2 rounded-2xl border border-indigo-200 bg-indigo-50/40 p-3 sm:p-5">
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between"><div><h2 className="text-lg font-bold text-slate-900">3. Pratinjau dan Periksa</h2><p className="mt-1 text-sm text-slate-600">Pratinjau ini belum diterbitkan dan belum masuk Riwayat Surat. Nomor final baru dibuat setelah Anda memilih Terbitkan Surat.</p></div><button type="button" onClick={() => { setPreviewOpen(false); setValidated(false); }} className="inline-flex min-h-10 items-center justify-center gap-1 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"><X className="h-4 w-4" /> Batal</button></div>
