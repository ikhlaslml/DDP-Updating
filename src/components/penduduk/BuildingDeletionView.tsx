  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-rose-100 bg-white p-5 shadow-sm sm:p-6">
        <div className="flex items-start gap-3"><span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-rose-50 text-rose-600"><Trash2 className="h-5 w-5" /></span><div><h2 className="text-lg font-bold text-slate-900">Pilih Bangunan yang Akan Dihapus</h2><p className="mt-1 max-w-3xl text-sm leading-relaxed text-slate-500">Gunakan untuk bangunan fisik yang sudah tidak ada, misalnya karena gusur atau bencana. Data penghuni, nomor KK, dan riwayatnya tidak ikut dihapus.</p></div></div>
